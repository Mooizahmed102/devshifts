...
<body>
    ...
    <div class="mil-wrapper">
           ...
           <div class="mil-additional-panel">
               <div class="container-fluid">
                   <ul class="mil-ap-list">
                       <li>Phone: <span class="mil-accent">+ 01</span> 800 070 404</li>
                       <li>Info@mydomain.com</li>
                   </ul>
                   <div class="mil-ap-call-to-action">
        ...
        <!-- banner -->
        <div class="mil-banner mil-top-space-100">
            <div class="mil-deco mil-deco-accent" style="top: 0; left: 12%;"></div>
            <div class="swiper-container mil-banner-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">

                        <img src="img/photo/4.jpg" class="mil-background-image" style="object-position: center" data-swiper-parallax-scale="1.1" alt="image">
                        ...
                        <div class="mil-banner-content-2" data-swiper-parallax-y="300" data-swiper-parallax-duration="600" data-swiper-parallax-opacity="0">
                            <div class="container">
                                <div class="row align-items-center justify-content-center mil-text-center">
                                    <div class="col-xl-8">
                                        <span class="mil-suptitle mil-mb-60"><span class="mil-light">Our</span> <span class="mil-accent">Inspiration</span></span>
                                        <h1 class="mil-mb-50"><span class="mil-uppercase mil-light">The</span> <span class="mil-font-3 mil-accent">Freedom</span><span class="mil-uppercase mil-light"> to focus on <br>
                                                improving</span> <span class="mil-font-3 mil-accent">Your</span> <span class="mil-uppercase mil-light">business or idea </span></h1>
                                        <p class="mil-light-soft mil-mb-60">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse <br> molestie consequat, vel illum dolore eu feugiat nulla.</p>
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="img/photo/5.jpg" class="mil-background-image" style="object-position: bottom" data-swiper-parallax-scale="1.1" alt="image">
                        <div class="mil-overlay"></div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="img/photo/6.jpg" class="mil-background-image" style="object-position: center" data-swiper-parallax-scale="1.1" alt="image">
                        <div class="mil-overlay"></div>
        ...
        <section class="mil-call-to-action mil-p-120-120">
            ...
            <div class="container">
                <div class="mil-cta-content">
                    ...
                    <h2 class="mil-h1 mil-light mil-mb-30">Compare <span class="mil-accent">ITSulu</span> Plans</h2>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-icon-box mil-center mil-mb-60">
                            ...
                            <p class="mil-text-sm mil-mb-20">Data Security</p>
                            <h5>Quis ipsum suspendisse <br>ultrices gravida</h5>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-icon-box mil-center mil-mb-60">
                            ...
                            <p class="mil-text-sm mil-mb-20">SEO and Optimazation</p>
                            <h5>Quis ipsum suspendisse <br>ultrices gravida</h5>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-icon-box mil-center mil-mb-60">
                            ...
                            <p class="mil-text-sm mil-mb-20">Analytics and Research</p>
                            <h5>Quis ipsum suspendisse <br>ultrices gravida</h5>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-icon-box mil-center mil-mb-60">
                            ...
                            <p class="mil-text-sm mil-mb-20">IT Management Services</p>
                            <h5>Quis ipsum suspendisse <br>ultrices gravida</h5>
                        </div>
        ...
        <section class="mil-awards">
            <div class="row m-0">
                <div class="col-xl-6 p-0 mil-relative">
                    ...
                    <img src="img/photo/9.jpg" class="mil-background-image" style="object-position: center" data-swiper-parallax-scale="1.1" alt="image">
                    <div class="mil-overlay"></div>

                    <div class="mil-fake-container">
                        <span class="mil-suptitle mil-suptitle-2 mil-light mil-mb-30">Hard Work</span>
                        <h2 class="mil-light mil-mb-30">Our <span class="mil-accent">Awards</span> and Tecognitions</h2>
                        <p class="mil-light-soft mil-mb-30">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                        <a href="#." class="mil-link"><span class="mil-light">About us</span><i class="fas fa-arrow-right"></i></a>
                    </div>
                        ...
                        <div class="col-md-6 col-xl-6 p-0">
                            ...
                            <div class="mil-awards-box mil-gradient-bg">
                                <div class="mil-icon-box mil-center">
                                    ...
                                    <h5 class="mil-light mil-mb-20">CSS Design</h5>
                                    <p class="mil-text-sm mil-light-soft">Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-6 p-0">
                            ...
                            <div class="mil-awards-box mil-box-2 mil-gradient-bg">
                                <div class="mil-icon-box mil-center">
                                    ...
                                    <h5 class="mil-light mil-mb-20">W3 Design Award</h5>
                                    <p class="mil-text-sm mil-light-soft">Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-6 p-0">
                            ...
                            <div class="mil-awards-box mil-gradient-bg">
                                <div class="mil-icon-box mil-center">
                                    ...
                                    <h5 class="mil-light mil-mb-20">The FWA Award</h5>
                                    <p class="mil-text-sm mil-light-soft">Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-6 p-0">
                            ...
                            <div class="mil-awards-box mil-box-2 mil-pb-60-adapt mil-gradient-bg">
                                <div class="mil-icon-box mil-center">
                                    ...
                                    <h5 class="mil-light mil-mb-20">WWW Awards</h5>
                                    <p class="mil-text-sm mil-light-soft">Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>
                                </div>
                            </div>
