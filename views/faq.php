...
<body>
    ...
    <div class="mil-wrapper">
        ...
        <!-- faq -->
        <section class="mil-faqs mil-p-0-120">
            <div class="mil-deco" style="bottom: 0; left: 10%; transform: rotate(180deg)"></div>
            <div class="container">
                ...
                <div class="mil-tabs">
                    ...
                    <div class="mil-tab">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-4">
                                <h3 class="mil-up-font mil-mb-30"><span class="mil-accent">ITSulu Connects</span> The Entire Organization From End To End.</h3>
                                <p class="mil-mb-60">Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius.</p>
                            </div>
                            <div class="col-lg-7">
                    ...
                    <div class="mil-tab">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-4">
                                <h3 class="mil-up-font mil-mb-30"><span class="mil-accent">Lorem ipsum</span> dolor sit amet, consectetur adipisicing elit.</h3>
                                <p class="mil-mb-60">Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius.</p>
                            </div>
                            <div class="col-lg-7">
                    ...
                    <div class="mil-tab">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-4">
                                <h3 class="mil-up-font mil-mb-30"><span class="mil-accent">Lorem Ipsum</span> available, but the majority have suffered</h3>
                                <p class="mil-mb-60">Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem.</p>
                            </div>
                            <div class="col-lg-7">
                    ...
                    <div class="mil-tab">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-4">
                                <h3 class="mil-up-font mil-mb-30"><span class="mil-accent">Aliquam aut natus</span> perspiciatis corporis sunt alias cumques.</h3>
                                <p class="mil-mb-60">Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem.</p>
                            </div>
                            <div class="col-lg-7">
