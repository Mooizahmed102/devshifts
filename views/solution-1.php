        ...
        <section class="mil-p-120-0">
            <div class="container">
                ...
                <div class="mil-text-center mil-mb-90">
                    ...
                    <h2>AI Consulting and Development Company <br> With <span class="mil-accent">Extensive Know How</span></h2>
                </div>
        ...
        <section class="mil-awards">
            <div class="row m-0">
                <div class="col-xl-6 p-0 mil-relative">
                    ...
                    <img src="img/photo/14.jpg" class="mil-background-image" style="object-position: center" data-swiper-parallax-scale="1.1" alt="image">
