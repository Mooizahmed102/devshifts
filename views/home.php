...
<body>
    ...
    <div class="mil-wrapper">
            ...
            <div class="swiper-container mil-banner-slideshow">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="img/top-view-painting-supplies-with-copy-space.png" class="mil-background-image" style="object-position: center" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1" alt="image">
                    </div>
                    <div class="swiper-slide">
                        <img src="img/top-view-painting-supplies-with-copy-space.png" class="mil-background-image" style="object-position: center" data-swiper-parallax="-100" data-swiper-parallax-scale="1.1" alt="image">
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-8">
                            ...
                            <div class="mil-flex-hori-center">
                                <div>
                                    <a href="#contact-us" class="mil-button mil-border mil-light"><span>Let’s Talk</span></a>
                                </div>
                                <!-- <p class="mil-button-descr mil-light-soft">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> -->
                            </div>
                        </div>
                        <div class="col-xl-4">
                ...
                <div class="row mil-mb-30-adapt">
                    <div class="col-xl-4">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <p>Network security services help protect a business' network from unauthorized access. IT services can create and issue access authorization to those who need it. They also provide many other services to protect your network, including</p>
                        </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <h4 class="mil-mb-15">Monitoring</h4>
                            <p>IT services can monitor your network, internet traffic, computers and other internet-enabled devices. Monitoring allows IT teams to keep track of who accesses their businesses' information, whether any technology requires repairs and if any computers need software updates or modifications.</p>
                        </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <h4 class="mil-mb-15">Email services</h4>
                            <p>Businesses and organizations rely on email for many communication purposes. From individual messages and company-wide updates to customer relations, email is an important part of maintaining business relationships.</p>
                        </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <h4 class="mil-mb-15">Backup solutions</h4>
                            <p>Backup solutions protect information loss from occurring by storing copies of data on external hardware or online platforms, such as a cloud service. Information backup services can help protect your business' information should any issues occur, like a power outage or system failure. </p>
                        </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <h4 class="mil-mb-15">Digital Marketing</h4>
                            <p>Digital marketing is the component of marketing that uses the Internet and online-based digital technology such as desktop computers, mobile phones and other digital media and platforms to promote products and services.</p>
                        </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <h4 class="mil-mb-15">Social media Marketing</h4>
        ...
        <!-- how it works -->
        <section class="mil-how-it-works mil-deep-bg mil-p-120-90" id="about-us">
            <div class="mil-deco" style="top: 0; right: 20%;"></div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <p>Engaging in conversation about what they do and why they do it, equipping your team with time and tools, and encouraging everyone as they contribute.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <p> It gives you a clue of the business process as you progress. It helps you understand the needs of your audience</p>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <p>At Fast we are future thinkers, supplying key technology and solutions to help our customers automate so they can focus on their core business</p>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="mil-mb-60">
                            ...
                            <p> investing in the right infrastructure and using emerging technology, organizations can gain a competitive edge when scaling up innovations.</p>
                        </div>
        ...
        <!-- contact -->
        <section class="mil-contact mil-gradient-bg mil-p-120-0" id="contact-us">
                ...
                <div class="mil-footer-content mil-p-120-90">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-xl-4 mil-mb-30">
                            ...
                            <img src="img/logo/devshifts.png" alt="" class="mil-logo mil-mb-30" style="width: 140px">

                            <p class="mil-light-soft mil-mb-30">It gives you a clue of the business process as you progress. It helps you understand the needs of your audience</p>
                        ...
                        <div class="col-xl-7 mil-mt-60-adapt">
                            ...
                            <div class="row">
                                <div class="col-lg-7 mil-mb-30">
                                    ...
                                    <h3 class="mil-light mil-up-font mil-mb-30">Join The <span class="mil-accent">Devshifts</span> <br>technology</h3>
