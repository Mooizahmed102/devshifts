            ...
            <div class="container">
                <div class="row justify-content-between mil-mb-90">
                    <div class="col-xl-6">
                        ...
                        <h3 class="mil-mb-30">Inspire and Get Inspired by <br><span class="mil-accent">Professional</span> Experts</h3>

                    </div>
                    <div class="col-xl-4">

                        <p>It uses a dictionary of over <span class="mil-accent">200 Latin words</span>, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable.</p>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-4 mil-mb-30">
                                ...
                                <div class="mil-adaptive-right">
                                    <a href="#." class="mil-button mil-border"><span>Apply Now</span></a>
                                </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-5 mil-mb-60">
                        ...
                        <span class="mil-suptitle mil-suptitle-2 mil-mb-30">Work With Us</span>
                        <h2 class="mil-mb-30">Why <span class="mil-accent">Choose</span> Us?</h2>
                        <p class="mil-mb-15">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
                        <p class="mil-mb-50">Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod facer possim assum.</p>
                        <div class="mil-buttons-frame">
                            <a href="#." class="mil-button mil-border"><span>Read more</span></a>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="mil-about-illustration-2">
                            ...
                            <a href="#." class="mil-play-button"><i class="fas fa-play"></i></a>
                        </div>
                    </div>
                </div>
            </div>
